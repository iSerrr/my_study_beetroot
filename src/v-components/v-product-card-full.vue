		...
		>
			<ul class="product-card__desc">
				...
				<li class="product-card__order-option">
					...
					<div class="count">
						<input v-model="count" type="number" name="" id="" />
					</div>
					<buttonMain
...
import productSlider from "./v-product-slider.vue";
import buttonMain from "./v-component-button-main.vue";
import ratingBar from "./v-component-rating-bar.vue";
